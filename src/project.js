require = function i(n, a, p) {
  ...
  HelloWorld: [function(e, t, r) {
    "use strict";
    cc._RF.push(t, "280c3rsZJJKnZ9RqbALVwtK", "HelloWorld"), cc.Class({
      ...
      update: function(e) {},
      qqbtnClick: function(e, t) {
        console.log("event=", e.type, " data=", t)
      }
    }), cc._RF.pop()
  }, {}],
    ...
    (function(global) {
      ...
      function binl2b64(e) {
        for (var t = "", r = 0; r < 4 * e.length; r += 3)
          for (var o = (e[r >> 2] >> r % 4 * 8 & 255) << 16 | (e[r + 1 >> 2] >> (r + 1) % 4 * 8 & 255) << 8 | e[r + 2 >> 2] >> (r + 2) % 4 * 8 & 255, s = 0; s < 4; s++) 8 * r + 6 * s > 32 * e.length ? t += b64pad : t += "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".charAt(o >> 6 * (3 - s) & 63);
        return t
      }
      var format = function(t) {
          for (var r, e, o, s, i = 1, n = [].slice.call(arguments), a = 0, p = t.length, g = "", u = !1, l = !1, c = function() {
              ...
              for (var e = "";
                /\d/.test(t[a]);) e += t[a++], r = t[a];
              return 0 < e.length ? parseInt(e) : null
            }; a < p; ++a)
            if (r = t[a], u) switch (u = !1, "." == r ? (l = !1, r = t[++a]) : "0" == r && "." == t[a + 1] ? (l = !0, r = t[a += 2]) : l = !0, s = m(), r) {
              case "b":
      ...
      MatchvsLog.openLog = function() {
        console.log("---- open log ----"), "undefined" == typeof wx ? (MatchvsLog.logI = console.log.bind(console, "[INFO ]  "), MatchvsLog.logE = console.error.bind(console, "[ERROR]  ")) : (MatchvsLog.logI = function() {
          var t = "";
          try {
            throw new Error
          } catch (e) {
          ...
          console.info("[INFO ] " + getNowFormatDate() + " " + this.toArray(arguments) + " " + t)
          ...
          console.error("[ERROR] " + getNowFormatDate() + " " + this.toArray(arguments) + " " + t)
        })
      ...
      function utf8ByteArrayToString(e) {
        for (var t = [], r = 0, o = 0; r < e.length;) {
          if ((n = e[r++]) < 128) t[o++] = String.fromCharCode(n);
          else if (191 < n && n < 224) {
            var s = e[r++];
      ...
      function getHotelUrl(e) {
        return "wss://" + e.mBookInfo.getWssproxy() + "/proxy?hotel=" + e.mBookInfo.getHoteladdr()
      }

      function commEngineStateCheck(e, t, r) {
        if ((e & ENGE_STATE.HAVE_INIT) !== ENGE_STATE.HAVE_INIT) return -2;
        if ((e & ENGE_STATE.INITING) === ENGE_STATE.INITING) return -3;
        if ((e & ENGE_STATE.HAVE_LOGIN) !== ENGE_STATE.HAVE_LOGIN) return -4;
        if ((e & ENGE_STATE.LOGINING) === ENGE_STATE.LOGINING) return -5;
        if ((e & ENGE_STATE.CREATEROOM) === ENGE_STATE.CREATEROOM) return -7;
        if ((e & ENGE_STATE.JOIN_ROOMING) === ENGE_STATE.JOIN_ROOMING) return -7;
        if ((e & ENGE_STATE.LOGOUTING) === ENGE_STATE.LOGOUTING) return -11;
        if (1 === r) {
          if ((e & ENGE_STATE.IN_ROOM) !== ENGE_STATE.IN_ROOM) return -6;
          if ((e & ENGE_STATE.LEAVE_ROOMING) === ENGE_STATE.LEAVE_ROOMING) return -10
        } else if (2 === r) {
          if ((e & ENGE_STATE.IN_ROOM) === ENGE_STATE.IN_ROOM) return -8;
          if ((e & ENGE_STATE.LEAVE_ROOMING) === ENGE_STATE.LEAVE_ROOMING) return -10
        } else if (3 === r && (e & ENGE_STATE.LEAVE_ROOMING) === ENGE_STATE.LEAVE_ROOMING) return -10;
        return 0
      }
      ...
      function MsCheckIn(e, t, r, o, s, i) {
        this.gameID = e, this.roomID = t, this.userID = r, this.bookID = o, this.book_key = s, this.hotelInfo = i
      }
      ...
      function MsRoomInfo(e, t, r) {
        this.roomID = e, this.roomProperty = t, this.ownerId = r, MatchvsLog.logI(this + " MsRoomInfo:" + JSON.stringify(this))
      }

      function MsRoomUserInfo(e, t) {
        this.userId = e, this.userProfile = t, MatchvsLog.logI(this + " MsRoomUserInfo:" + JSON.stringify(this))
      }

      function MsLeaveRoomRsp(e, t, r, o) {
        this.status = e, this.roomID = t, this.userId = r, this.cpProto = o, MatchvsLog.logI(this + " MsLeaveRoomRsp:" + JSON.stringify(this))
      }

      function MsLeaveRoomNotify(e, t, r, o) {
        this.userId = t, this.roomID = e, this.owner = r, this.cpProto = o, MatchvsLog.logI(this + " MsLeaveRoomNotify:" + JSON.stringify(this))
      }
      ...
      function MsSendEventGroupNotify(e, t, r) {
        this.srcUid = e, this.groups = t, this.cpProto = r
      }

      function MsRegistRsp(e, t, r, o, s) {
        this.status = e, this.id = t, this.token = r, this.name = o, this.avatar = s, MatchvsLog.logI("MsRegistRsp:" + JSON.stringify(this))
      }
      ...
      function MsCheckInNotify(e, t, r, o) {
        this.userID = e, this.checkins = t, this.players = r, this.maxPlayers = o, MatchvsLog.logI(this + ":" + JSON.stringify(this))
      }

      function MsSendEventNotify(e, t) {
        this.srcUserId = e, this.cpProto = t
      }
      ...
      function MsKickPlayerNotify(e, t, r, o) {
        this.userId = e, this.srcUserId = t, this.cpProto = r, this.owner = o, MatchvsLog.logI(this + " MsKickPlayerNotify:" + JSON.stringify(this))
      }
      ...
      "function" != typeof String.prototype.startsWith && (String.prototype.startsWith = function(e) {
        ...
        function i(n, a, p) {
          function g(r, e) {
            if (!a[r]) {
              if (!n[r]) {
                var t = "function" == typeof _require && _require;
                if (!e && t) return t(r, !0);
                if (u) return u(r, !0);
          ...
          1: [function(_require, module, exports) {
            (function(global) {
              ...
              $jscomp.global = $jscomp.getGlobal(this), $jscomp.initSymbol = function() {
                ...
                var o = [];
                if ($jscomp.initSymbol(), $jscomp.initSymbolIterator(), "function" == typeof(s = e[Symbol.iterator]) && (e = s.call(e)), "function" == typeof e.next)
                  for (; !(s = e.next()).done;) o.push(t.call(r, s.value));
                else
                  for (var s = e.length, i = 0; i < s; i++) o.push(t.call(r, e[i]));
                return o
                ...
                if (e = Number(e), t = Number(t), r = Number(null != r ? r : o), e < t)
                  ...
                  for (e += (r = Math.min(r, o + t - e)) - t; t < r;) --r in this ? this[--e] = this[r] : delete this[e];
                return this
                ...
                e += "";
                for (var o = r.length, s = e.length, i = Math.max(0, Math.min(0 | t, r.length)), n = 0; n < s && i < o;)
                  if (r[i++] != e[n++]) return !1;
                return s <= n
              ...
              goog.global = this, goog.isDef = function(e) {
                ...
                if (goog.DEPENDENCIES_ENABLED) {
                  ...
                  for (o = 0; t = r[o]; o++) e in i._requires || (i._requires[e] = {}), i._requires[e][t] = !0
                }
                ...
                if (!COMPILED) {
                  ...
                  throw e = "goog._require could not find: " + e, goog.logToConsole_(e), Error(e)
                }
                ...
                if ((e = goog.getPathFromDeps_(e)) && e in goog.dependencies_._requires)
                  for (var t in goog.dependencies_._requires[e])
                ...
                for (function e(t) {
                    if (!(t in i.written || t in i.visited)) {
                      if (i.visited[t] = !0, t in i._requires)
                        for (var r in i._requires[t])
                ...
                i = !1;
                for (var n = e.constructor; n; n = n.superClass_ && n.superClass_.constructor)
                  if (n.prototype[t] === o) i = !0;
                  else if (i) return n.prototype[t].apply(e, s);
                ...
                if (goog.defineClass.SEAL_CLASS_INSTANCES && Object.seal instanceof Function) {
                  if (e && e.prototype && e.prototype[goog.UNSEALABLE_CONSTRUCTOR_PROPERTY_]) return r;
                  return function e() {
                ...
                return goog.string.newLineToBr(e.replace(/ {2}/g, " &#160;"), t)
              ...
              jspb.Map.prototype.loadFromArray_ = function() {
                ...
                for (var o = e.length, s = [], i = 0, n = goog.isString(e) ? e.split("") : e, a = 0; a < o; a++)
                  if (a in n) {
                    var p = n[a];
                ...
                for (var t = [], r = 0; r < arguments.length; r++) {
                  ...
                  if (goog.isArray(o))
                    for (var s = 0; s < o.length; s += 8192)
                      for (var i = goog.array.slice(o, s, s + 8192), n = (i = goog.array.flatten.apply(null, i), 0); n < i.length; n++) t.push(i[n]);
                  else t.push(o)
                }
                return t
              ...
              }, goog.userAgent.isDocumentMode = goog.userAgent.isDocumentModeOrHigher, goog.userAgent.DOCUMENT_MODE = (mx = goog.global.document, nx = goog.userAgent.getDocumentMode_(), mx && goog.userAgent.IE ? nx || ("CSS1Compat" == mx.compatMode ? parseInt(goog.userAgent.VERSION, 10) : 5) : void 0), goog.userAgent.product = {}, goog.userAgent.product.ASSUME_FIREFOX = !1, goog.userAgent.product.ASSUME_IPHONE = !1, goog.userAgent.product.ASSUME_IPAD = !1, goog.userAgent.product.ASSUME_ANDROID = !1, goog.userAgent.product.ASSUME_CHROME = !1, goog.userAgent.product.ASSUME_SAFARI = !1, goog.userAgent.product.PRODUCT_KNOWN_ = goog.userAgent.ASSUME_IE || goog.userAgent.ASSUME_EDGE || goog.userAgent.ASSUME_OPERA || goog.userAgent.product.ASSUME_FIREFOX || goog.userAgent.product.ASSUME_IPHONE || goog.userAgent.product.ASSUME_IPAD || goog.userAgent.product.ASSUME_ANDROID || goog.userAgent.product.ASSUME_CHROME || goog.userAgent.product.ASSUME_SAFARI, goog.userAgent.product.OPERA = goog.userAgent.OPERA, goog.userAgent.product.IE = goog.userAgent.IE, goog.userAgent.product.EDGE = goog.userAgent.EDGE, goog.userAgent.product.FIREFOX = goog.userAgent.product.PRODUCT_KNOWN_ ? goog.userAgent.product.ASSUME_FIREFOX : goog.labs.userAgent.browser.isFirefox(), goog.userAgent.product.isIphoneOrIpod_ = function() {
                ...
                if (e.wrappers_ = jspb.Message.MINIMIZE_MEMORY_ALLOCATIONS ? null : {}, t || (t = r ? [r] : []), e.messageId_ = r ? String(r) : void 0, e.arrayIndexOffset_ = 0 === r ? -1 : 0, e.array = t, jspb.Message.initPivotAndExtensionObject_(e, o), e.convertedFloatingPointFields_ = {}, s)
                ...
                if (e.array.length) {
                  var r = e.array.length - 1,
                    o = e.array[r];
                  if (o && "object" == (void 0 === o ? "undefined" : _typeof(o)) && !jspb.Message.isArray_(o) && !(jspb.Message.SUPPORTS_UINT8ARRAY_ && o instanceof Uint8Array)) return e.pivot_ = r - e.arrayIndexOffset_, void(e.extensionObject_ = o)
                ...
                for (var i in r) {
                  ...
                  if (null != a) {
                    for (var p in n.fieldName)
                      if (n.fieldName.hasOwnProperty(p)) break;
              ...
              }, jspb.Message.computeOneofCase = function(r, e) {
                var o, s;
                return goog.array.forEach(e, function(e) {
                  var t = jspb.Message.getField(r, e);
                  goog.isDefAndNotNull(t) && (o = e, s = t, jspb.Message.setField(r, e, void 0))
                }), o ? (jspb.Message.setField(r, o, s), o) : 0
                ...
                for (o in r = {}, e) null != (t = e[o]) && (r[o] = "object" == (void 0 === t ? "undefined" : _typeof(t)) ? jspb.Message.clone_(t) : t);
                return r
                ...
                return e.constructor === Uint8Array ? e : e.constructor === ArrayBuffer || e.constructor === Array ? new Uint8Array(e) : e.constructor === String ? goog.crypt.base64.decodeStringToUint8Array(e) : (goog.asserts.fail("Type not convertible to Uint8Array."), new Uint8Array(0))
                ...
                for (var t = this.buffer_.length, r = 0; r < e.length; r++) {
                  ...
                  else if (o < 2048) this.buffer_.push(o >> 6 | 192), this.buffer_.push(63 & o | 128);
                  else if (o < 65536)
                ...
                if (r |= (127 & (e = this.bytes_[this.cursor_++])) << 28, t = 0 | (127 & e) >> 4, e < 128) this.tempLow_ = r >>> 0, this.tempHigh_ = t >>> 0;
                else {
                  for (o = 0; o < 5; o++)
          ...
          3: [function(e, t, r) {
            var o, s = e("./sdk_pb"),
              i = e("./gateway_pb"),
              n = e("./errorcode_pb");
            t.exports = (_defineProperty(o = {
              DataProto: s
            }, "DataProto", i), _defineProperty(o, "DataProto", n), o)
          }, {
            "./errorcode_pb": 2,
            "./gateway_pb": 4,
            "./sdk_pb": 5
          ...
          4: [function(e, t, r) {
            ...
            o.exportSymbol("proto.stream.BookInfo", null, i), o.exportSymbol("proto.stream.CmdId", null, i), o.exportSymbol("proto.stream.ConnDetailV2", null, i), o.exportSymbol("proto.stream.CreateRoom", null, i), o.exportSymbol("proto.stream.CreateRoomRsp", null, i), o.exportSymbol("proto.stream.DisconnectReq", null, i), o.exportSymbol("proto.stream.DisconnectRsp", null, i), o.exportSymbol("proto.stream.GetRoomDetailReq", null, i), o.exportSymbol("proto.stream.GetRoomDetailRsp", null, i), o.exportSymbol("proto.stream.GetRoomList", null, i), o.exportSymbol("proto.stream.GetRoomListExReq", null, i), o.exportSymbol("proto.stream.GetRoomListExRsp", null, i), o.exportSymbol("proto.stream.GetRoomListRsp", null, i), o.exportSymbol("proto.stream.HeartbeatReq", null, i), o.exportSymbol("proto.stream.HeartbeatRsp", null, i), o.exportSymbol("proto.stream.JoinOpenNotify", null, i), o.exportSymbol("proto.stream.JoinOpenReq", null, i), o.exportSymbol("proto.stream.JoinOpenRsp", null, i), o.exportSymbol("proto.stream.JoinOverNotify", null, i), o.exportSymbol("proto.stream.JoinOverReq", null, i), o.exportSymbol("proto.stream.JoinOverRsp", null, i), o.exportSymbol("proto.stream.JoinRoomReq", null, i), o.exportSymbol("proto.stream.JoinRoomRsp", null, i), o.exportSymbol("proto.stream.JoinRoomType", null, i), o.exportSymbol("proto.stream.KickPlayer", null, i), o.exportSymbol("proto.stream.KickPlayerNotify", null, i), o.exportSymbol("proto.stream.KickPlayerRsp", null, i), o.exportSymbol("proto.stream.LeaveRoomReq", null, i), o.exportSymbol("proto.stream.LeaveRoomRsp", null, i), o.exportSymbol("proto.stream.LoginReq", null, i), o.exportSymbol("proto.stream.LoginRsp", null, i), o.exportSymbol("proto.stream.LogoutRsp", null, i), o.exportSymbol("proto.stream.NetworkStateNotify", null, i), o.exportSymbol("proto.stream.NetworkStateReq", null, i), o.exportSymbol("proto.stream.NetworkStateRsp", null, i), o.exportSymbol("proto.stream.NoticeJoin", null, i), o.exportSymbol("proto.stream.NoticeLeave", null, i), o.exportSymbol("proto.stream.NoticeRoomProperty", null, i), o.exportSymbol("proto.stream.PlayerInfo", null, i), o.exportSymbol("proto.stream.RoomDetail", null, i), o.exportSymbol("proto.stream.RoomFilter", null, i), o.exportSymbol("proto.stream.RoomInfo", null, i), o.exportSymbol("proto.stream.RoomInfoEx", null, i), o.exportSymbol("proto.stream.RoomListSort", null, i), o.exportSymbol("proto.stream.RoomState", null, i), o.exportSymbol("proto.stream.SetRoomPropertyReq", null, i), o.exportSymbol("proto.stream.SetRoomPropertyRsp", null, i), o.exportSymbol("proto.stream.SortOrder", null, i), o.exportSymbol("proto.stream.TcpProtoHeader", null, i), o.exportSymbol("proto.stream.UserV2", null, i), o.exportSymbol("proto.stream.keyValue", null, i), proto.stream.LoginReq = function(e) {
              ...
              var r = void 0;
              0 !== (r = e.getGameid()) && t.writeUint32(1, r), 0 < (r = e.getAppkey()).length && t.writeString(2, r), 0 < (r = e.getDeviceid()).length && t.writeString(3, r), 0 < (r = e.getSign()).length && t.writeString(4, r), 0 < (r = e.getSdkver()).length && t.writeString(5, r), 0 !== (r = e.getVendor()) && t.writeUint32(6, r)
              ...
              var r = void 0;
              r = e.getRoomid(), 0 !== parseInt(r, 10) && t.writeUint64String(1, r), 0 < (r = e.getRoomname()).length && t.writeString(2, r), 0 !== (r = e.getMaxplayer()) && t.writeUint32(3, r), 0 !== (r = e.getMode()) && t.writeInt32(4, r), 0 !== (r = e.getCanwatch()) && t.writeInt32(5, r), 0 !== (r = e.getVisibility()) && t.writeInt32(6, r), 0 < (r = e.getRoomproperty_asU8()).length && t.writeBytes(7, r), 0 !== (r = e.getOwner()) && t.writeUint32(8, r)
              ...
              var t = new s.BinaryReader(e),
                r = new proto.stream.GetRoomList;
              ...
              var r = void 0;
              r = e.getRoomid(), 0 !== parseInt(r, 10) && t.writeUint64String(1, r), 0 !== (r = e.getState()) && t.writeUint32(2, r), 0 !== (r = e.getMaxplayer()) && t.writeUint32(3, r), 0 !== (r = e.getMode()) && t.writeInt32(4, r), 0 !== (r = e.getCanwatch()) && t.writeInt32(5, r), 0 < (r = e.getRoomproperty_asU8()).length && t.writeBytes(6, r), 0 !== (r = e.getOwner()) && t.writeUint32(7, r), 0 !== (r = e.getCreateflag()) && t.writeUint32(8, r), 0 < (r = e.getPlayerinfosList()).length && t.writeRepeatedMessage(9, r, proto.stream.PlayerInfo.serializeBinaryToWriter)
              ...
              s.Message.initialize(this, e, 0, -1, null, null)
            }, o.inherits(proto.stream.SetRoomPropertyReq, s.Message);
            o.DEBUG && !COMPILED && (proto.stream.SetRoomPropertyReq.displayName = "proto.stream.SetRoomPropertyReq"), s.Message.GENERATE_TO_OBJECT && (proto.stream.SetRoomPropertyReq.prototype.toObject = function(e) {
          ...
          5: [function(e, t, r) {
            ...
            s.exportSymbol("proto.stream.Broadcast", null, i), s.exportSymbol("proto.stream.BroadcastAck", null, i), s.exportSymbol("proto.stream.CheckIn", null, i), s.exportSymbol("proto.stream.CheckInAck", null, i), s.exportSymbol("proto.stream.CheckInNotify", null, i), s.exportSymbol("proto.stream.FrameBroadcast", null, i), s.exportSymbol("proto.stream.FrameBroadcastAck", null, i), s.exportSymbol("proto.stream.FrameDataNotify", null, i), s.exportSymbol("proto.stream.FrameSyncNotify", null, i), s.exportSymbol("proto.stream.Heartbeat", null, i), s.exportSymbol("proto.stream.HeartbeatAck", null, i), s.exportSymbol("proto.stream.Notify", null, i), s.exportSymbol("proto.stream.Publish", null, i), s.exportSymbol("proto.stream.PublishAck", null, i), s.exportSymbol("proto.stream.PublishNotify", null, i), s.exportSymbol("proto.stream.SDKHotelCmdID", null, i), s.exportSymbol("proto.stream.SetFrameSyncRate", null, i), s.exportSymbol("proto.stream.SetFrameSyncRateAck", null, i), s.exportSymbol("proto.stream.SetFrameSyncRateNotify", null, i), s.exportSymbol("proto.stream.SetUseTimeStamp", null, i), s.exportSymbol("proto.stream.SetUseTimeStampAck", null, i), s.exportSymbol("proto.stream.Subscribe", null, i), s.exportSymbol("proto.stream.SubscribeAck", null, i), proto.stream.CheckIn = function(e) {
              ...
              var r = void 0;
              0 !== (r = e.getGameid()) && t.writeUint32(1, r), r = e.getRoomid(), 0 !== parseInt(r, 10) && t.writeUint64String(2, r), 0 !== (r = e.getPriority()) && t.writeUint32(3, r), 0 !== (r = e.getFramerate()) && t.writeUint32(4, r), 0 !== (r = e.getFrameidx()) && t.writeUint32(5, r)
              ...
              var r = void 0;
              0 !== (r = e.getPriority()) && t.writeUint32(1, r), 0 !== (r = e.getFramerate()) && t.writeUint32(2, r), 0 !== (r = e.getFrameidx()) && t.writeUint32(3, r), r = e.getTimestamp(), 0 !== parseInt(r, 10) && t.writeUint64String(4, r)
              ...
              var r = void 0;
              r = e.getRoomid(), 0 !== parseInt(r, 10) && t.writeUint64String(1, r), 0 !== (r = e.getPriority()) && t.writeUint32(2, r), 0 < (r = e.getCpproto_asU8()).length && t.writeBytes(3, r)
      ...
      try {
        "undefined" != typeof wx ? (MatchvsNetWork = function(e, t) {
          var r = null,
            o = !1,
            s = [],
            i = t,
          ...
          this.close = function() {
            ...
            for (MatchvsLog.logI("[wx.WebSocket][connect]:" + e), o = !0; 0 < s.length;) a.send(s.pop());
            i.onConnect && i.onConnect(n)
          }), r.onClose(function(e) {
            o = !1, i.onDisConnect && i.onDisConnect(n, e), MatchvsLog.logI("[wx.WebSocket] [onClose] case:" + JSON.stringify(e))
          }), r.onMessage(function(e) {
            var t = new DataView(e.data);
            i.onMsg(t)
          }), r.onError(function(e) {
            i.onDisConnect && i.onDisConnect(n, e), MatchvsLog.logI("[wx.WebSocket] [onError] case:" + JSON.stringify(e))
          })
          ...
          function r(e, r, t, o) {
            wx.request({
              ...
              success: function(e) {
                ...
                var t = JSON.parse(JSON.stringify(e.data).replace(/\u00A0|\u2028|\u2029|\uFEFF/g, '' ));
          ...
          this.send = function(e) {
            if (window.WebSocket) {
              ...
              o.readyState === WebSocket.OPEN ? o.send(e) : i.push(e)
            }
          }, this.close = function() {
            o && o.close()
          }, window.WebSocket || (window.WebSocket = window.MozWebSocket), window.WebSocket ? ((o = new WebSocket(e)).hashcode = (new Date).getMilliseconds(), MatchvsLog.logI("try to create a socket:" + r + " socket is " + o.hashcode), o.onmessage = function(e) {
            var r = new FileReader;
            r.readAsArrayBuffer(e.data), r.onload = function(e) {
              if (e.target.readyState === FileReader.DONE) {
                var t = new DataView(r.result);
                s.onMsg(t)
              } else s.onErr(1606, "[err]parse fail")
            }
          }, o.onopen = function(e) {
            for (MatchvsLog.logI("Create the socket is success :" + r + " socket is " + o.hashcode); 0 < i.length;) o.send(i.pop());
            s.onConnect && s.onConnect(r)
          }, o.onclose = function(e) {
            s.onDisConnect && s.onDisConnect(r, e), MatchvsLog.logI("socket on closed ,code:" + e.code + "(1000:NORMAL,1005:CLOSE_NO_STATUS,1006:RESET,1009:CLOSE_TOO_LARGE) msg:" + e.reason)
          }, o.onerror = function(e) {
            MatchvsLog.logI("socket on error ,event:" + JSON.stringify(e)), s.onDisConnect && s.onDisConnect(r, e)
      ...
      var MATCHVS_USER_GATEWAY_SPEED_REQ = 1001,
        MATCHVS_USER_GATEWAY_SPEED_RSP = 1002,
        MATCHVS_USER_LOGIN_REQ = 1101,
        MATCHVS_USER_LOGIN_RSP = 1102,
        MATCHVS_USER_HEARTBEAT_REQ = 1103,
        MATCHVS_USER_HEARTBEAT_RSP = 1103,
        MATCHVS_NOTICE_USER_RELOGIN = 1104,
        MATCHVS_USER_LOGOUT_REQ = 1105,
        MATCHVS_USER_LOGOUT_RSP = 1106,
        MATCHVS_NETWORK_STATE_NOTIFY = 1122,
        MATCHVS_ROOM_CREATE_REQ = 1203,
        MATCHVS_ROOM_CREATE_RSP = 1204,
        MATCHVS_ROOM_JOIN_REQ = 1201,
        MATCHVS_ROOM_JOIN_RSP = 1202,
        MATCHVS_ROOM_JOIN_OVER_REQ = 1213,
        MATCHVS_ROOM_JOIN_OVER_RSP = 1214,
        MATCHVS_ROOM_JOIN_OVER_NOTIFY = 1306,
        MATCHVS_ROOM_LEAVE_REQ = 1205,
        MATCHVS_ROOM_LEAVE_RSP = 1206,
        MATCHVS_ROOM_NOTICE_USER_JOIN = 1301,
        MATCHVS_ROOM_NOTICE_USER_LEAVE = 1302,
        MATCHVS_ROOM_CHECK_IN_REQ = 1401,
        MATCHVS_ROOM_CHECK_IN_RSP = 1402,
        MATCHVS_HEARTBEAT_HOTEL_REQ = 1403,
        MATCHVS_HEARTBEAT_HOTEL_RSP = 1404,
        MATCHVS_BROADCAST_HOTEL_REQ = 1405,
        MATCHVS_BROADCAST_HOTEL_RSP = 1406,
        MATCHVS_HOTEL_NOTIFY = 1408,
        MATCHVS_ROOM_CHECKIN_NOTIFY = 1410,
        CMD_GET_ROOM_LIST_REQ = 1207,
        CMD_GET_ROOM_LIST_RSP = 1208,
        CMD_GET_ROOM_DETAIL_REQ = 1209,
        CMD_GET_ROOM_DETAIL_RSP = 1210,
        CMD_GET_ROOM_LIST_EX_REQ = 1215,
        CMD_GET_ROOM_LIST_EX_RSP = 1216,
        CMD_SET_ROOM_PROPERTY_REQ = 1219,
        CMD_SET_ROOM_PROPERTY_RSP = 1220,
        CMD_SET_ROOM_PROPERTY_NOTIFY = 1307,
        CMD_DISCONNECT_REQ = 1107,
        CMD_DISCONNECT_RSP = 1108,
        CMD_KICK_PLAYER_REQ = 1303,
        CMD_KICK_PLAYER_RSP = 1304,
        CMD_KICK_PLAYER_NOTIFY = 1305,
        CMD_SUBSCRIBE_CMDID = 1411,
        CMD_SUBSCRIBE_ACK_CMDID = 1412,
        CMD_PUBLISH_CMDID = 1413,
        CMD_PUBLISH_ACKCMDID = 1414,
        CMD_PUBLISH_NOTIFYCMDID = 1416,
        CMD_SET_USE_TIMESTAMP_CMDID = 1417,
        CMD_SET_USE_TIMESTAMPACK_CMDID = 1418,
        CMD_SET_FRAME_SYNCRATE_CMDID = 1419,
        CMD_SET_FRAME_SYNCRATEACK_CMDID = 1420,
        CMD_SET_FRAME_SYNCRATENOTIFY_CMDID = 1422,
        CMD_FRAME_BROADCAST_CMDID = 1423,
        CMD_FRAME_BROADCASTACK_CMDID = 1424,
        CMD_FRAME_DATANOTIFY_CMDID = 1426,
        CMD_FRAME_SYNCNOTIFY_CMDID = 1428,
        CMD_ROOM_JOIN_OPEN_REQ = 1221,
        CMD_ROOM_JOIN_OPEN_RSP = 1222,
        CMD_ROOM_JOIN_OPEN_NOT = 1308,
        FIXED_HEAD_SIZE = 16,
        VERSION = 2;
      ...
      function MatchvsProtocol() {
        ...
        this.msProtoMap = new MatchvsProtoMap, this.fillHeader = function(e, t) {
        ...
        }, this.init = function() {}, this.login = function(e, t, r, o, s, i, n, a) {
          ...
          var r = new proto.stream.GetRoomList,
            o = new proto.stream.RoomFilter;
          ...
          var r = new proto.stream.GetRoomListExReq,
            o = new proto.stream.RoomFilter;
      ...
      function MatchvsEngine() {
        (M_ENGINE = this).mChannel = "MatchVS", this.mPlatform = "release", this.mMsPubArgs = new MsPublicMemberArgs, this.mEngineState = ENGE_STATE.NONE, this.mAllPlayers = [], this.mRecntRoomID = 0, this.mUserListForJoinRoomRsp = [], this.joinRoomNotifyInfo = null, this.mNetWork = null, this.mHotelNetWork = null, this.mBookInfo = null, this.mHotelHeartBeatTimer = null, this.mProtocol = new MatchvsProtocol;
        var g = function(A) {
          ...
          this.onMsg = function(e) {
            ...
            t;
            var r = A.mProtocol.handleMsg(e),
              o = new proto.stream.RoomInfo;
            switch (r && r.header, r.header.cmd) {
              case MATCHVS_USER_LOGIN_RSP:
                if (200 === r.payload.getStatus() ? A.mEngineState |= ENGE_STATE.HAVE_LOGIN : (A.mEngineState &= ~ENGE_STATE.LOGINING, A.mEngineState &= ~ENGE_STATE.RECONNECTING, A.mRsp.errorResponse && A.mRsp.errorResponse(r.payload.getStatus(), "Login is fail,Server Response Error")), A.mEngineState &= ~ENGE_STATE.LOGINING, A.mRecntRoomID = r.payload.getRoomid(), (A.mEngineState & ENGE_STATE.RECONNECTING) === ENGE_STATE.RECONNECTING)
                  if ("0" !== A.mRecntRoomID) {
                    var s = new MsRoomJoin(MsEnum.JoinRoomType.reconnect, A.mMsPubArgs.userID, A.mRecntRoomID, A.mMsPubArgs.gameID, 0, 0, 0, "reconnect", [{
                        name: "MatchVS"
                      }]),
                      i = A.mProtocol && A.mProtocol.joinRoomSpecial(s);
                    A.mNetWork && A.mNetWork.send(i)
                  } else A.mEngineState &= ~ENGE_STATE.RECONNECTING, A.mRsp.reconnectResponse && A.mRsp.reconnectResponse(201, null, null);
                else A.mRsp.loginResponse(new MsLoginRsp(r.payload.getStatus(), A.mRecntRoomID));
                break;
              case MATCHVS_ROOM_JOIN_RSP:
                200 === r.payload.getStatus() ? (A.mEngineState |= ENGE_STATE.IN_ROOM, A.mBookInfo = r.payload.getBookinfo(), A.mRoomInfo = r.payload.getRoominfo(), A.mUserListForJoinRoomRsp = r.payload.getUsersList(), HttpConf.HOST_HOTEL_ADDR = getHotelUrl(A), A.mHotelNetWork = new MatchvsNetWork(HttpConf.HOST_HOTEL_ADDR, A.mNetWorkCallBackImp), A.mNetWorkCallBackImp.onConnect = function(e) {
                  A.roomCheckIn(A.mHotelNetWork, A.mBookInfo, A.mRoomInfo), A.mRsp.onConnect && A.mRsp.onConnect(e)
                }, null == A.mHotelHeartBeatTimer && (A.mHotelHeartBeatTimer = setInterval(A.hotelHeartBeat, HEART_BEAT_INTERVAL))) : (A.mEngineState &= ~ENGE_STATE.JOIN_ROOMING, A.mEngineState &= ~ENGE_STATE.RECONNECTING, A.mRsp.errorResponse && A.mRsp.errorResponse(r.payload.getStatus(), "Server Response Error"), A.mRsp.joinRoomResponse && A.mRsp.joinRoomResponse(r.payload.getStatus(), null, null));
                break;
              case MATCHVS_ROOM_CREATE_RSP:
                if (200 === r.payload.getStatus()) {
                  A.mEngineState |= ENGE_STATE.IN_ROOM, A.mBookInfo = r.payload.getBookinfo();
                  var n = r.payload.getRoomid();
                  o.setRoomid(n), o.setOwner(r.payload.getOwner()), A.mRoomInfo = o, HttpConf.HOST_HOTEL_ADDR = getHotelUrl(A), A.mHotelNetWork = new MatchvsNetWork(HttpConf.HOST_HOTEL_ADDR, A.mNetWorkCallBackImp), A.mNetWorkCallBackImp.onConnect = function(e) {
                    A.roomCheckIn(A.mHotelNetWork, A.mBookInfo, A.mRoomInfo), A.mRsp.onConnect && A.mRsp.onConnect(e)
                  }, null == A.mHotelHeartBeatTimer && (A.mHotelHeartBeatTimer = setInterval(A.hotelHeartBeat, HEART_BEAT_INTERVAL))
                } else A.mEngineState &= ~ENGE_STATE.CREATEROOM, A.mRsp.errorResponse && A.mRsp.errorResponse(r.payload.getStatus(), "Server Response Error");
                break;
              case MATCHVS_ROOM_CHECK_IN_RSP:
                200 !== r.payload.getStatus() && A.mRsp.errorResponse && A.mRsp.errorResponse(r.payload.getStatus(), "Server Response Error"), A.mAllPlayers = r.payload.getCheckinsList();
                var a = [];
                A.mUserListForJoinRoomRsp.forEach(function(e) {
                  var t = new MsRoomUserInfo(e.getUserid(), utf8ByteArrayToString(e.getUserprofile()));
                  a.push(t)
                });
                var p = new MsRoomInfo(A.mRoomInfo.getRoomid(), utf8ByteArrayToString(A.mRoomInfo.getRoomproperty()), A.mRoomInfo.getOwner());
                (A.mEngineState & ENGE_STATE.CREATEROOM) === ENGE_STATE.CREATEROOM ? (A.mEngineState &= ~ENGE_STATE.CREATEROOM, A.mRsp.createRoomResponse && A.mRsp.createRoomResponse(new MsCreateRoomRsp(r.payload.getStatus(), A.mRoomInfo.getRoomid(), A.mRoomInfo.getOwner()))) : (A.mEngineState & ENGE_STATE.JOIN_ROOMING) === ENGE_STATE.JOIN_ROOMING ? (A.mEngineState &= ~ENGE_STATE.JOIN_ROOMING, A.mRsp.joinRoomResponse && A.mRsp.joinRoomResponse(r.payload.getStatus(), a, p)) : (A.mEngineState & ENGE_STATE.RECONNECTING) === ENGE_STATE.RECONNECTING && (A.mEngineState &= ~ENGE_STATE.RECONNECTING, A.mRsp.reconnectResponse && A.mRsp.reconnectResponse(r.payload.getStatus(), a, p));
                break;
              case MATCHVS_ROOM_CHECKIN_NOTIFY:
                A.joinRoomNotifyInfo && A.mRsp.joinRoomNotify && A.mRsp.joinRoomNotify(A.joinRoomNotifyInfo), A.mAllPlayers = r.payload.getCheckinsList(), A.mRsp.roomCheckInNotify && A.mRsp.roomCheckInNotify(new MsCheckInNotify(r.payload.getUserid(), r.payload.getCheckinsList(), r.payload.getPlayersList(), r.payload.getMaxplayers())), A.joinRoomNotifyInfo = null;
                break;
              case MATCHVS_ROOM_LEAVE_RSP:
                A.mEngineState &= ~ENGE_STATE.LEAVE_ROOMING, 200 !== r.payload.getStatus() && A.mRsp.errorResponse && A.mRsp.errorResponse(r.payload.getStatus(), "Server Response Error"), o.setRoomid("0"), A.mRoomInfo = o;
                var g = new MsLeaveRoomRsp(r.payload.getStatus(), r.payload.getRoomid(), r.payload.getUserid(), r.payload.getCpproto());
                A.mRsp.leaveRoomResponse && A.mRsp.leaveRoomResponse(g), A.mEngineState &= ~ENGE_STATE.IN_ROOM;
                break;
              case MATCHVS_ROOM_JOIN_OVER_RSP:
                200 !== r.payload.getStatus() && A.mRsp.errorResponse && A.mRsp.errorResponse(r.payload.getStatus(), "Server Response Error"), A.mRsp.joinOverResponse && A.mRsp.joinOverResponse(new MsJoinOverRsp(r.payload.getStatus(), utf8ByteArrayToString(r.payload.getCpproto())));
                break;
              case MATCHVS_ROOM_NOTICE_USER_JOIN:
                A.joinRoomNotifyInfo = new MsRoomUserInfo(r.payload.getUser().getUserid(), utf8ByteArrayToString(r.payload.getUser().getUserprofile()));
                break;
              case MATCHVS_ROOM_NOTICE_USER_LEAVE:
                var u = new MsLeaveRoomNotify(r.payload.getRoomid(), r.payload.getUserid(), r.payload.getOwner(), utf8ByteArrayToString(r.payload.getCpproto()));
                A.mRsp.leaveRoomNotify && A.mRsp.leaveRoomNotify(u);
                break;
              case MATCHVS_HEARTBEAT_HOTEL_RSP:
                A.mRsp.hotelHeartBeatRsp && A.mRsp.hotelHeartBeatRsp(r.payload.getStatus()), MatchvsLog.logI("hotelHeartBeatRsp");
                break;
              case MATCHVS_BROADCAST_HOTEL_RSP:
                200 !== r.payload.getStatus() && A.mRsp.errorResponse && A.mRsp.errorResponse(r.payload.getStatus(), "Server Response Error"), A.mRsp.sendEventResponse && A.mRsp.sendEventResponse(new MsSendEventRsp(r.payload.getStatus(), r.header.seq));
                break;
              case MATCHVS_HOTEL_NOTIFY:
                0 === r.payload.getSrcuid() ? A.mRsp.gameServerNotify && A.mRsp.gameServerNotify(new MsGameServerNotifyInfo(r.payload.getSrcuid(), utf8ByteArrayToString(r.payload.getCpproto()))) : A.mRsp.sendEventNotify && A.mRsp.sendEventNotify(new MsSendEventNotify(r.payload.getSrcuid(), utf8ByteArrayToString(r.payload.getCpproto())));
                break;
              case CMD_SUBSCRIBE_ACK_CMDID:
                A.mRsp.subscribeEventGroupResponse && A.mRsp.subscribeEventGroupResponse(r.payload.getStatus(), r.payload.getGroupsList());
                break;
              case CMD_PUBLISH_ACKCMDID:
                A.mRsp.sendEventGroupResponse && A.mRsp.sendEventGroupResponse(r.payload.getStatus(), r.payload.getDstnum());
                break;
              case CMD_PUBLISH_NOTIFYCMDID:
                A.mRsp.sendEventGroupNotify && A.mRsp.sendEventGroupNotify(r.payload.getSrcuid(), r.payload.getGroupsList(), utf8ByteArrayToString(r.payload.getCpproto()));
                break;
              case MATCHVS_USER_GATEWAY_SPEED_RSP:
                var l = r.payload.getStatus(),
                  c = r.payload.getSeq();
                A.mRsp.gatewaySpeedResponse && A.mRsp.gatewaySpeedResponse(new MsGatewaySpeedResponse(l, c));
                break;
              case MATCHVS_USER_HEARTBEAT_RSP:
                var m = r.payload.getGameid(),
                  d = r.payload.getGsexist();
                A.mEngineState |= ENGE_STATE.HAVE_LOGIN, A.mRsp.heartBeatResponse && A.mRsp.heartBeatResponse(new MsHeartBeatResponse(m, d)), MatchvsLog.logI("gatewayHeartBeatResponse");
                break;
              case MATCHVS_USER_LOGOUT_RSP:
                A.mNetWork.close(), A.mRsp.logoutResponse && A.mRsp.logoutResponse(r.payload.getStatus());
                break;
              case MATCHVS_NETWORK_STATE_NOTIFY:
                A.mRsp.networkStateNotify && A.mRsp.networkStateNotify(new MsNetworkStateNotify(r.payload.getRoomid(), r.payload.getUserid(), r.payload.getState(), r.payload.getOwner()));
                break;
              case CMD_GET_ROOM_LIST_RSP:
                for (var f = r.payload.getRoominfoList(), y = [], h = 0; h < f.length; h++) y[h] = new MsRoomInfoEx(f[h].getRoomid(), f[h].getRoomname(), f[h].getMaxplayer(), f[h].getMode(), f[h].getCanwatch(), utf8ByteArrayToString(f[h].getRoomproperty()));
                A.mRsp.getRoomListResponse && A.mRsp.getRoomListResponse(r.payload.getStatus(), y);
                break;
              case CMD_DISCONNECT_RSP:
                A.mRsp.disConnectResponse && A.mRsp.disConnectResponse(r.payload.getStatus());
                break;
              case CMD_KICK_PLAYER_RSP:
                A.mRsp.kickPlayerResponse && A.mRsp.kickPlayerResponse(new MsKickPlayerRsp(r.payload.getStatus(), r.payload.getOwner(), r.payload.getUserid()));
                break;
              case CMD_KICK_PLAYER_NOTIFY:
                r.payload.getUserid().toString() === "" + A.mUserID && null != A.mHotelHeartBeatTimer && (clearInterval(A.mHotelHeartBeatTimer), A.mHotelHeartBeatTimer = null, A.mEngineState &= ~ENGE_STATE.IN_ROOM, A.mEngineState |= ENGE_STATE.HAVE_LOGIN, A.mHotelNetWork.close()), A.mRsp.kickPlayerNotify && A.mRsp.kickPlayerNotify(new MsKickPlayerNotify(r.payload.getUserid(), r.payload.getSrcuserid(), utf8ByteArrayToString(r.payload.getCpproto()), r.payload.getOwner()));
                break;
              case CMD_SET_FRAME_SYNCRATEACK_CMDID:
                MatchvsLog.logI("SetFrameSyncRateAck:" + r.payload), A.mRsp.setFrameSyncResponse && A.mRsp.setFrameSyncResponse(new MsSetChannelFrameSyncRsp(r.payload.getStatus()));
                break;
              case CMD_SET_FRAME_SYNCRATENOTIFY_CMDID:
                break;
              case CMD_FRAME_BROADCASTACK_CMDID:
                A.mRsp.sendFrameEventResponse && A.mRsp.sendFrameEventResponse(new MsSendFrameEventRsp(r.payload.getStatus()));
                break;
              case CMD_FRAME_DATANOTIFY_CMDID:
                F.push(new MsFrameItem(r.payload.getSrcuid(), utf8ByteArrayToString(r.payload.getCpproto()), r.payload.getTimestamp()));
                break;
              case CMD_FRAME_SYNCNOTIFY_CMDID:
                for (var R = []; 0 < F.length;) R.push(F.pop());
                var b = new MsFrameData(r.payload.getLastidx(), R, R.length);
                A.mRsp.frameUpdate && A.mRsp.frameUpdate(b);
                break;
              case CMD_GET_ROOM_LIST_EX_RSP:
                var _ = r.payload.getRoominfoexList(),
                  E = [];
                ...
                var M = new MsGetRoomListExRsp(r.payload.getStatus(), r.payload.getTotal(), E);
                A.mRsp.getRoomListExResponse && A.mRsp.getRoomListExResponse(M);
                break;
              case CMD_GET_ROOM_DETAIL_RSP:
                200 !== r.payload.getStatus() && (A.mRsp.getRoomDetailResponse && A.mRsp.getRoomDetailResponse(new MsGetRoomDetailRsp(r.payload.getStatus())), A.mRsp.errorResponse && A.mRsp.errorResponse(r.payload.getStatus(), "Server error"));
                var S = r.payload.getRoomdetail(),
                  I = [];
                S.getPlayerinfosList().forEach(function(e) {
                  var t = new MsRoomUserInfo(e.getUserid(), utf8ByteArrayToString(e.getUserprofile()));
                  I.push(t)
                });
                var T = new MsGetRoomDetailRsp(r.payload.getStatus(), S.getState(), S.getMaxplayer(), S.getMode(), S.getCanwatch(), utf8ByteArrayToString(S.getRoomproperty()), S.getOwner(), S.getCreateflag(), I);
                A.mRsp.getRoomDetailResponse && A.mRsp.getRoomDetailResponse(T);
                break;
              case MATCHVS_ROOM_JOIN_OVER_NOTIFY:
                var O = new MsJoinOverNotifyInfo(r.payload.getRoomid(), r.payload.getSrcuserid(), utf8ByteArrayToString(r.payload.getCpproto()));
                A.mRsp.joinOverNotify && A.mRsp.joinOverNotify(O);
                break;
              case CMD_SET_ROOM_PROPERTY_RSP:
                200 !== r.payload.getStatus() && A.errorResponse && A.errorResponse(r.payload.getStatus(), "Server response error"), A.mRsp.setRoomPropertyResponse && A.mRsp.setRoomPropertyResponse(new MsSetRoomPropertyRspInfo(r.payload.getStatus(), r.payload.getRoomid(), r.payload.getUserid(), utf8ByteArrayToString(r.payload.getRoomproperty())));
                break;
              case CMD_SET_ROOM_PROPERTY_NOTIFY:
                A.mRsp.setRoomPropertyNotify && A.mRsp.setRoomPropertyNotify(new MsRoomPropertyNotifyInfo(r.payload.getRoomid(), r.payload.getUserid(), utf8ByteArrayToString(r.payload.getRoomproperty())));
                break;
              case CMD_ROOM_JOIN_OPEN_RSP:
                A.mRsp.joinOpenResponse && A.mRsp.joinOpenResponse(new MsReopenRoomResponse(r.payload.getStatus(), utf8ByteArrayToString(r.payload.getCpproto())));
                break;
              case CMD_ROOM_JOIN_OPEN_NOT:
                A.mRsp.joinOpenNotify && A.mRsp.joinOpenNotify(new MsReopenRoomNotify(r.payload.getRoomid(), r.payload.getUserid(), utf8ByteArrayToString(r.payload.getCpproto())))
            }
          }, this.onErr = function(e, t) {
            A.mRsp.errorResponse && A.mRsp.errorResponse(e, t)
          }, this.onConnect = function(e) {
            A.mRsp.onConnect && A.mRsp.onConnect(e), r = setInterval(A.heartBeat, HEART_BEAT_INTERVAL)
          }, this.onDisConnect = function(e, t) {
            A.mRsp.onDisConnect && A.mRsp.onDisConnect(e), e.endsWith(HttpConf.HOST_GATWAY_ADDR) ? ((A.mEngineState & ENGE_STATE.LOGOUTING) !== ENGE_STATE.LOGOUTING && (t && t.code && (1e3 === t.code || 1005 === t.code) ? MatchvsLog.logI("gateway close is friend") : A.mRsp.errorResponse && A.mRsp.errorResponse(1001, "gateway network error")), A.mEngineState = ENGE_STATE.NONE, A.mEngineState |= ENGE_STATE.HAVE_INIT, MatchvsLog.logI("EngineState", A.mEngineState), clearInterval(r)) : e.endsWith(HttpConf.HOST_HOTEL_ADDR) && (MatchvsLog.logI("hotel disconnect"), (A.mEngineState & ENGE_STATE.LEAVE_ROOMING) !== ENGE_STATE.LEAVE_ROOMING && (t && t.code && (1e3 === t.code || 1005 === t.code) ? MatchvsLog.logI("hotel close is friend") : A.mRsp.errorResponse && A.mRsp.errorResponse(1001, "hotel network error")), null != A.mHotelHeartBeatTimer && (clearInterval(A.mHotelHeartBeatTimer), A.mHotelHeartBeatTimer = null), A.mEngineState &= ~ENGE_STATE.LEAVE_ROOMING, A.mEngineState &= ~ENGE_STATE.IN_ROOM)
          }
        };
        this.init = function(e, t, r, o) {
          return this.mRsp = e, this.mChannel = t, this.mPlatform = r, this.mGameID = o, this.mMsPubArgs.channel = t, this.mMsPubArgs.platform = r, this.mEngineState = ENGE_STATE.INITING, this.mProtocol.init(), this.getHostList(), 0
          ...
          if ("0" !== this.mRecntRoomID && (this.mEngineState & ENGE_STATE.HAVE_LOGIN) === ENGE_STATE.HAVE_LOGIN) {
            ...
            var e = new MsRoomJoin(MsEnum.JoinRoomType.reconnect, this.mMsPubArgs.userID, this.mRecntRoomID, this.mMsPubArgs.gameID, 0, 0, 0, "reconnect", [{
                name: "MatchVS"
              }]),
          ...
          void 0 !== this.mNetWork && null !== this.mNetWork && this.mNetWork.close(), this.mEngineState |= ENGE_STATE.LOGINING, this.mEngineState |= ENGE_STATE.RECONNECTING, this.mNetWorkCallBackImp = new g(this), this.mNetWork = new MatchvsNetWork(HttpConf.HOST_GATWAY_ADDR, this.mNetWorkCallBackImp);
          ...
          void 0 !== this.mNetWork && null !== this.mNetWork && this.mNetWork.close(), this.mNetWorkCallBackImp = new g(this), this.mNetWork = new MatchvsNetWork(HttpConf.HOST_GATWAY_ADDR, this.mNetWorkCallBackImp), this.mUserID = e, this.mToken = t, this.mGameID = r, this.mGameVersion = o, this.mAppKey = s, this.mMsPubArgs.userID = e, this.mMsPubArgs.token = t, this.mMsPubArgs.gameID = r, this.mMsPubArgs.gameVersion = o, this.mMsPubArgs.appKey = s, this.mMsPubArgs.deviceID = n, this.mMsPubArgs.gatewayID = a, this.mMsPubArgs.secretKey = i;
          var p = this.mProtocol.login(e, t, r, o, s, i, n, a);
          return this.mEngineState |= ENGE_STATE.LOGINING, this.mNetWork.send(p), MatchvsLog.logI("login,userID" + e + ", token:" + t), 0
        }, this.speed = function() {
          ...
          return this.mEngineState = ENGE_STATE.NONE, MatchvsLog.logI("unInit "), 0
        ...
        }, this.roomCheckIn = function(e, t, r) {
          var o = this.mProtocol.roomCheckIn(t, r, this.mUserID, this.mGameID);
          return e.send(o), 0
        }, this.joinRandomRoom = function(e, t) {
          var r = commEngineStateCheck(this.mEngineState, this.mEngineState, 2);
          if (0 !== r) return r;
          if (e > MVSCONFIG.MAXPLAYER_LIMIT || e <= 0) return -20;
          if (512 < t.length) return -21;
          var o = new MsRoomJoin(MsEnum.JoinRoomType.joinRandomRoom, this.mUserID, 0, this.mGameID, e, 0, 0, t, [{
              name: "matchvs"
            }]),
          ...
          var o = String(e).trim();
          if (0 === o || "" === o) return -1;
          var s = new MsRoomJoin(MsEnum.JoinRoomType.joinSpecialRoom, this.mUserID, e, this.mGameID, 0, 0, 0, t, [{
              name: "MatchVS"
            }]),
          ...
          this.mRoomInfo && this.mRoomInfo.getRoomid && (r = this.mRoomInfo.getRoomid());
          ...
          return 1024 < o.byteLength ? -21 : (this.mNetWork.send(o), 0)
        }, this.setFrameSync = function(e) {
          var t = commEngineStateCheck(this.mEngineState, this.mEngineState, 1);
          if (0 !== t) return t;
          if (20 < e || e < 0) return -20;
          var r = this.mProtocol.setFrameSync(Number(e), this.mRoomInfo.getRoomid(), this.mGameID, 0, 1);
          return this.mHotelNetWork.send(r), 0
        }, this.sendFrameEvent = function(e) {
          var t = commEngineStateCheck(this.mEngineState, this.mEngineState, 1);
          if (0 !== t) return t;
          if (1024 < e.length) return -21;
          var r = this.mProtocol.sendFrameEvent(this.mRoomInfo.getRoomid(), 0, e);
          return this.mHotelNetWork.send(r), 0
      ...
      MsProtoMapDesc[MATCHVS_USER_LOGIN_RSP] = proto.stream.LoginRsp, MsProtoMapDesc[MATCHVS_USER_LOGIN_RSP] = proto.stream.LoginRsp, MsProtoMapDesc[MATCHVS_ROOM_JOIN_RSP] = proto.stream.JoinRoomRsp, MsProtoMapDesc[MATCHVS_ROOM_CREATE_RSP] = proto.stream.CreateRoomRsp, MsProtoMapDesc[MATCHVS_ROOM_CHECK_IN_RSP] = proto.stream.CheckInAck, MsProtoMapDesc[MATCHVS_ROOM_CHECKIN_NOTIFY] = proto.stream.CheckInNotify, MsProtoMapDesc[MATCHVS_ROOM_LEAVE_RSP] = proto.stream.LeaveRoomRsp, MsProtoMapDesc[MATCHVS_ROOM_JOIN_OVER_RSP] = proto.stream.JoinOverRsp, MsProtoMapDesc[MATCHVS_ROOM_NOTICE_USER_JOIN] = proto.stream.NoticeJoin, MsProtoMapDesc[MATCHVS_ROOM_NOTICE_USER_LEAVE] = proto.stream.NoticeLeave, MsProtoMapDesc[MATCHVS_HEARTBEAT_HOTEL_RSP] = proto.stream.HeartbeatAck, MsProtoMapDesc[MATCHVS_BROADCAST_HOTEL_RSP] = proto.stream.BroadcastAck, MsProtoMapDesc[MATCHVS_HOTEL_NOTIFY] = proto.stream.Notify, MsProtoMapDesc[CMD_SUBSCRIBE_ACK_CMDID] = proto.stream.SubscribeAck, MsProtoMapDesc[CMD_PUBLISH_ACKCMDID] = proto.stream.PublishAck, MsProtoMapDesc[CMD_PUBLISH_NOTIFYCMDID] = proto.stream.PublishNotify, MsProtoMapDesc[MATCHVS_USER_HEARTBEAT_RSP] = proto.stream.HeartbeatRsp, MsProtoMapDesc[MATCHVS_USER_LOGOUT_RSP] = proto.stream.LogoutRsp, MsProtoMapDesc[CMD_GET_ROOM_LIST_RSP] = proto.stream.GetRoomListRsp, MsProtoMapDesc[CMD_DISCONNECT_RSP] = proto.stream.DisconnectRsp, MsProtoMapDesc[CMD_KICK_PLAYER_RSP] = proto.stream.KickPlayerRsp, MsProtoMapDesc[CMD_KICK_PLAYER_NOTIFY] = proto.stream.KickPlayerNotify, MsProtoMapDesc[CMD_SET_FRAME_SYNCRATEACK_CMDID] = proto.stream.SetFrameSyncRateAck, MsProtoMapDesc[CMD_SET_FRAME_SYNCRATENOTIFY_CMDID] = proto.stream.SetFrameSyncRateNotify, MsProtoMapDesc[CMD_FRAME_BROADCASTACK_CMDID] = proto.stream.FrameBroadcastAck, MsProtoMapDesc[CMD_FRAME_DATANOTIFY_CMDID] = proto.stream.FrameDataNotify, MsProtoMapDesc[CMD_FRAME_SYNCNOTIFY_CMDID] = proto.stream.FrameSyncNotify, MsProtoMapDesc[MATCHVS_NETWORK_STATE_NOTIFY] = proto.stream.NetworkStateNotify, MsProtoMapDesc[CMD_GET_ROOM_LIST_EX_RSP] = proto.stream.GetRoomListExRsp, MsProtoMapDesc[CMD_GET_ROOM_DETAIL_RSP] = proto.stream.GetRoomDetailRsp, MsProtoMapDesc[MATCHVS_ROOM_JOIN_OVER_NOTIFY] = proto.stream.JoinOverNotify, MsProtoMapDesc[CMD_SET_ROOM_PROPERTY_RSP] = proto.stream.SetRoomPropertyRsp, MsProtoMapDesc[CMD_SET_ROOM_PROPERTY_NOTIFY] = proto.stream.NoticeRoomProperty, MsProtoMapDesc[CMD_ROOM_JOIN_OPEN_RSP] = proto.stream.JoinOpenRsp, MsProtoMapDesc[CMD_ROOM_JOIN_OPEN_NOT] = proto.stream.JoinOpenNotify, MatchvsProtocol.prototype.heartBeat = function(e, t) {
      ...
      }, MatchvsProtocol.prototype.setFrameSync = function(e, t, r, o, s) {
        var i = new proto.stream.SetFrameSyncRate;
        i.setGameid(r), i.setRoomid(t), i.setPriority(o), i.setFramerate(e), i.setFrameidx(s);
        var n = i.serializeBinary();
        return this.fillHeader(n, CMD_SET_FRAME_SYNCRATE_CMDID)
      }, MatchvsProtocol.prototype.sendFrameEvent = function(e, t, r) {
        var o = new proto.stream.FrameBroadcast;
        o.setRoomid(e), o.setPriority(t), o.setCpproto(stringToUtf8ByteArray(r));
        var s = o.serializeBinary();
        ...
        if ((this.mEngineState & ENGE_STATE.HAVE_LOGIN) !== ENGE_STATE.HAVE_LOGIN) return -4;
        (this.mEngineState & ENGE_STATE.IN_ROOM) === ENGE_STATE.IN_ROOM && (this.mEngineState |= ENGE_STATE.LEAVE_ROOMING, this.leaveRoom("user logout"), this.mHotelNetWork && this.mHotelNetWork.close());
        ...
        var e = M_ENGINE;
        if (void 0 !== e.mGameID && "" !== e.mGameID && 0 !== e.mGameID) {
          var t;
          t = void 0 === e.mRoomInfo ? 0 : e.mRoomInfo.getRoomid();
          var r = e.mProtocol.heartBeat(e.mGameID, t);
          e.mNetWork.send(r), MatchvsLog.logI("gateway heartBeat")
        }
        ...
        return 1024 < s.byteLength ? -21 : (this.mHotelNetWork.send(s), {
          sequence: this.mProtocol.seq - 1,
          result: 0
        })
        ...
        return 1024 < t.length ? -21 : (this.mHotelNetWork.send(s), {
          sequence: this.mProtocol.seq - 1,
          result: 0
        })
        ...
        var e = M_ENGINE;
        this.mEngineState |= ENGE_STATE.IN_ROOM, this.mEngineState |= ENGE_STATE.HAVE_LOGIN;
        ...
        if ((this.mEngineState & ENGE_STATE.HAVE_INIT) !== ENGE_STATE.HAVE_INIT) return -2;
        var e = this.mChannel,
          r = "regUserInfo" + e + this.mPlatform,
          t = this.mGameVersion,
          o = LocalStore_Load(r);
        if (o) {
          var s = JSON.parse(o);
        ...
        return new MatchvsHttp(n).get(i), n.rsp = this.mRsp.registerUserResponse, n.onMsg = function(e) {
          var t = JSON.parse(e);
          0 === t.status ? (LocalStore_Save(r, e), this.rsp(new MsRegistRsp(t.status, t.data.userid, t.data.token, t.data.nickname, t.data.avatar))) : this.rsp(new MsRegistRsp(t.status, 0, "0", e, ""))
        }, n.onErr = function(e, t) {
          this.rsp(new MsRegistRsp(e, 0, "0", t, ""))
        }, 0
      }, MatchvsEngine.prototype.getHostList = function() {
        var e = "https://sdk.matchvs.com/v1/gateway/query?mac=0&gameid=" + this.mGameID + "&channel=" + this.mChannel + "&platform=" + this.mPlatform + "&useWSSProxy=1",
          t = new MatchvsNetWorkCallBack,
          o = this;
        return new MatchvsHttp(t).get(e), t.onMsg = function(e) {
          var t = JSON.parse(e);
          if (200 === t.status) {
            o.mEngineState |= ENGE_STATE.HAVE_INIT, o.mEngineState &= ~ENGE_STATE.INITING;
            var r = "https://";
            HttpConf.REGISTER_USER_URL = r + t.data.vsuser;
            HttpConf.HOST_GATWAY_ADDR = "wss://" + t.data.wssProxy, HttpConf.CMSNS_URL = r + t.data.cmsns, HttpConf.VS_OPEN_URL = r + t.data.vsopen, HttpConf.VS_PAY_URL = r + t.data.vspay, HttpConf.VS_PRODUCT_URL = r + t.data.VS_PRODUCT_URL
          }
          o.mRsp.initResponse(t.status)
        }, t.onErr = function(e, t) {
          console.error("getHostListErrCode" + e + " getHostListErrMsg" + t), o.mRsp.errorResponse(e, t)
        }, 0
